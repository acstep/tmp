...
function UsedPostWindow() {
	...
	function usedPostCallback(result, resultmsg){
		if(result == true){
			Ti.API.info('Post Used Event success.');
			forwardView.visible = false;
	...
	function postUsedEvent(){
		...
		createvent(datastring ,usedPostCallback);
	}

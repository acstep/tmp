...
function drawTeambuyEvent(view, data, lon, lat){
	...
	feedView.categoryText.text = '   ' + L('teambuying') +'   ';
	feedView.categoryText.backgroundColor = '#9b59b6';
	feedView.categoryImg.image = 'teambuy.png';
...
function drawTeambuyContnet(contentView,data){

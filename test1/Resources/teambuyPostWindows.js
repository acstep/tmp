//TeamBuy Post Window Component Constructor
Ti.include("common_net.js");



function TeambuyPostWindow() {
	...
	function teambuyPostCallback(result, resultmsg){
		if(result == true){
			Ti.API.info('Post Teambuy Event success.');
			forwardView.visible = false;
	...
	function postTeambuyEvent(){
		...
		createvent(datastring ,teambuyPostCallback);
	}
...
module.exports = TeambuyPostWindow;